    ...
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24 bg-black text-white selection:bg-purple-500 selection:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 w-full max-w-6xl">
        {results.map((result, index) => (
          <div
            key={index}
            className="group rounded-xl border border-gray-800 bg-gray-900/50 p-6 hover:border-gray-700 hover:bg-gray-900 transition-all duration-200"
          >
            ...
            <div className="flex items-center text-xs text-gray-500 mt-auto pt-4 border-t border-gray-800">
              <svg
